...
@section('content')
	<form action="#">
		...
		<div class="form-group col-md-6 col-md-offset-3 col-centered">
			<label for="contact_details" class="input_label_padding"><span style="color: red;">*</span>འབྲེལ་བ་འཐབ་ས།</label>
			<textarea name="contact_details" cols="30" rows="10" class="form-control"></textarea>
		</div>
		<div class="form-group col-md-6 col-md-offset-3 col-centered">
			<label for="image">པར།</label>
